...
class Phonem(AudioSegment):
    ...
    def __init__(self, start_timestamp, end_timestamp, phonem, related_audio_path):
        AudioSegment.__init__(self, start_timestamp, end_timestamp, phonem, related_audio_path)
