...
if __name__ == "__main__":
  ...
  parser.add_argument('-c', '--audio-command', default=DEFAULT_AUDIO_COMMAND,
      help=AUDIO_COMMAND_HELP)
  parser.add_argument('video_urls', metavar='VIDEO_URL', nargs='+',
      action='store', help=VIDEO_URL_HELP)
  parser.add_argument('-s', '--skip', dest='skip_first_analysis',
      action='store_true', default=False, help=SKIP_ANALYSIS_HELP)
