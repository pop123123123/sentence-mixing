...
def get_all_audio_phonems(randomizer):
    """
...
@functools.lru_cache(maxsize=1)
def get_transcription_dict_audio_phonem(randomizer):
    """
    ...
    for phonem in get_all_audio_phonems(randomizer):
...
def get_candidates(target_phonem, randomizer):
    """
    ...
    audio_phonems = get_transcription_dict_audio_phonem(randomizer)[
